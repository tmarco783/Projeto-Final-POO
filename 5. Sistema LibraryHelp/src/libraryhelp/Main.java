...
public class Main {
    public static void main(String[] args) {
        ...
        Administrador adm1 = new Administrador(1578, "Marco", 21);
        adm1.cadastrarAdministrador(adm1);
        
        Administrador adm2 = new Administrador(1579, "Mathews", 22);
        adm2.cadastrarAdministrador(adm2);
        
        Administrador adm3 = new Administrador(1580, "Aline", 25);
